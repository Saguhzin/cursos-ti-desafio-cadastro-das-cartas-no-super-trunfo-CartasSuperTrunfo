...
int main(){
  ...
  // ==================================================================================
    ...
    // ==================================================================================
      ...
      float areaKm, pib, densidadePopulacional, pibPercapta, superPoder;
    ...
    // ==================================================================================
      ...
      float areaKm2, pib2, densidadePopulacional2, pibPercapta2, superPoder2;
  ...
  // ==================================================================================  
    ...
    //fgets(Variavel , tamanho do vetor do tipo char, stdin)
  ...
  // =========================
    ...
    // =========================
      ...
      printf("\nÁrea: Carta 1 venceu (%d)", (areaKm>areaKm2));
      
      printf("\nPIB: Carta 1 venceu (%d)", (pib>pib2));
      
      printf("\nPontos Turísticos: Carta 1 venceu (%d)", (pontosTuristicos> pontosTuristicos2));
      
      printf("\nDensidade Populacional: Carta 1 venceu (%d)",(densidadePopulacional< densidadePopulacional2));
      
      printf("\nPIB per Capita: Carta 1 venceu (%d)", (pibPercapta>pibPercapta2));
      
      printf("\nSuper Poder: Carta 1 venceu (%d)", (superPoder>superPoder2));
